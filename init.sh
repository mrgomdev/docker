...
if [ "$1" == "sudo" ] ; then
  ...
  echo -n "init.sh] Running in sudo? (y/N)"
  read is_sudo
fi
...
if [ "$is_sudo" == "y" ] ; then
  ...
  sudo apt-get -y install htop vim openssh-server wget build-essential sudo curl zsh git language-pack-en libcap-dev
  sudo update-locale
elif [ "$is_sudo" != "n" ] && [ "$is_sudo" != "" ] ; then
  echo "init.sh] Invalid Input: $is_sudo"
  echo "init.sh] Valid inputs: [y] [n, '']"
else
  echo "init.sh] Skipping sudo commands..."
fi

if [ "$USER" == "root" ] && [ "$(logname)" != "" ] ; then
  echo "init.sh] you ran this script in sudo. Restarting this script without root permission..."
...
if [ "$(which zsh)" == "" ] || [ "$(which zsh)" == "zsh is not found" ] ; then
  echo "init.sh] zsh should be installed before init.sh."
  exit 1
fi
echo "init.sh] Post installation for zsh..."
...
cd $TEMP_DIR && git clone https://github.com/powerline/fonts.git --depth=1 && cd fonts && ./install.sh && cd .. && rm -rf fonts && sed -i 's/ZSH_THEME=.*/ZSH_THEME=\"agnoster\"/' $HOME/.zshrc

mkdir -p $HOME/local/bin
echo -e "#\!/usr/bin/bash\nexport LS_COLORS=\"rs=0:di=01;33:ln=01;36:mh=00:pi=40;33:so=01;35:do=01;35:bd=40;33;01:cd=40;33;01:or=40;31;01:mi=00:su=37;41:sg=30;43:ca=30;41:tw=30;42:ow=34;42:st=37;44:ex=01;32:*.tar=01;31:*.tgz=01;31:*.arc=01;31:*.arj=01;31:*.taz=01;31:*.lha=01;31:*.lz4=01;31:*.lzh=01;31:*.lzma=01;31:*.tlz=01;31:*.txz=01;31:*.tzo=01;31:*.t7z=01;31:*.zip=01;31:*.z=01;31:*.Z=01;31:*.dz=01;31:*.gz=01;31:*.lrz=01;31:*.lz=01;31:*.lzo=01;31:*.xz=01;31:*.zst=01;31:*.tzst=01;31:*.bz2=01;31:*.bz=01;31:*.tbz=01;31:*.tbz2=01;31:*.tz=01;31:*.deb=01;31:*.rpm=01;31:*.jar=01;31:*.war=01;31:*.ear=01;31:*.sar=01;31:*.rar=01;31:*.alz=01;31:*.ace=01;31:*.zoo=01;31:*.cpio=01;31:*.7z=01;31:*.rz=01;31:*.cab=01;31:*.wim=01;31:*.swm=01;31:*.dwm=01;31:*.esd=01;31:*.jpg=01;35:*.jpeg=01;35:*.mjpg=01;35:*.mjpeg=01;35:*.gif=01;35:*.bmp=01;35:*.pbm=01;35:*.pgm=01;35:*.ppm=01;35:*.tga=01;35:*.xbm=01;35:*.xpm=01;35:*.tif=01;35:*.tiff=01;35:*.png=01;35:*.svg=01;35:*.svgz=01;35:*.mng=01;35:*.pcx=01;35:*.mov=01;35:*.mpg=01;35:*.mpeg=01;35:*.m2v=01;35:*.mkv=01;35:*.webm=01;35:*.ogm=01;35:*.mp4=01;35:*.m4v=01;35:*.mp4v=01;35:*.vob=01;35:*.qt=01;35:*.nuv=01;35:*.wmv=01;35:*.asf=01;35:*.rm=01;35:*.rmvb=01;35:*.flc=01;35:*.avi=01;35:*.fli=01;35:*.flv=01;35:*.gl=01;35:*.dl=01;35:*.xcf=01;35:*.xwd=01;35:*.yuv=01;35:*.cgm=01;35:*.emf=01;35:*.ogv=01;35:*.ogx=01;35:*.aac=00;36:*.au=00;36:*.flac=00;36:*.m4a=00;36:*.mid=00;36:*.midi=00;36:*.mka=00;36:*.mp3=00;36:*.mpc=00;36:*.ogg=00;36:*.ra=00;36:*.wav=00;36:*.oga=00;36:*.opus=00;36:*.spx=00;36:*.xspf=00;36:\"" > $HOME/local/bin/dir_colors.sh
chmod +x $HOME/local/bin/dir_colors.sh
echo -e "source \$HOME/local/bin/dir_colors.sh" >> $HOME/.zshrc
echo -e "source \$HOME/local/bin/dir_colors.sh" >> $HOME/.bashrc
echo -e "prompt_context() {\n  prompt_segment black default \"%n@%m\"\n}" >> $HOME/.zshrc

echo "init.sh] Showing essential parts of $HOME/.zshrc"
cat $HOME/.zshrc | sed '/^[ ]*#.*/d' | sed '/^$/d'
echo "init.sh] End of $HOME/.zshrc"

### conda
echo "init.sh] Setting base conda..."
cd $TEMP_DIR && wget -q https://repo.anaconda.com/miniconda/Miniconda3-latest-Linux-x86_64.sh && chmod +x $TEMP_DIR/Miniconda3-latest-Linux-x86_64.sh && $TEMP_DIR/Miniconda3-latest-Linux-x86_64.sh -b && eval "$($HOME/miniconda3/bin/conda shell.zsh hook)" && conda init zsh bash
conda install -y python=3.7
conda install -y msgpack-python msgpack-numpy psutil numpy pyzmq termcolor tabulate lmdb 
pip install tensorpack==0.11 python-prctl
